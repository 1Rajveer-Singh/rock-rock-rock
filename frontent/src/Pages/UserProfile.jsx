...
import { AdvancedInput, AdvancedSelect } from '../Components/Profile/AdvancedInput';
...
const UserProfile = () => {
  ...
  const [profile, setProfile] = useState({
    ...
    certifications: ['Professional Engineer (P.Eng)', 'Mine Safety Certification'],
  ...
  const stats = [
    { title: 'Sites Monitored', value: '24', icon: '', color: 'blue', trend: '+3', trendDirection: 'up' },
    { title: 'Predictions Made', value: '1,247', icon: '', color: 'purple', trend: '+127', trendDirection: 'up' },
    { title: 'Reports Generated', value: '86', icon: '', color: 'green', trend: '+12', trendDirection: 'up' },
    { title: 'Accuracy Rate', value: '94.2%', icon: '', color: 'orange', trend: '+2.1%', trendDirection: 'up' },
    { title: 'Years Experience', value: '10+', icon: '', color: 'indigo', trend: 'Stable', trendDirection: 'stable' },
    { title: 'Team Members', value: '12', icon: '', color: 'red', trend: '+2', trendDirection: 'up' }
  ];
  ...
  const recentActivity = [
    { 
      ...
      details: 'Comprehensive analysis of geological conditions and risk factors.',
      status: 'completed'
    },
    { 
  ...
  const tabs = [
    { id: 'overview', name: 'Overview', icon: '', description: 'Profile summary and statistics' },
    { id: 'personal', name: 'Personal Info', icon: '', description: 'Personal details and contact' },
    { id: 'professional', name: 'Professional', icon: '', description: 'Work and career information' },
    { id: 'activity', name: 'Activity', icon: '', description: 'Recent activity timeline' },
    { id: 'security', name: 'Security', icon: '', description: 'Account security settings' }
  ];
              ...
              {isEditing ? (
                <>
                  ...
                  <button
                    onClick={handleSave}
                    disabled={isLoading}
                    className="px-6 py-2 bg-gradient-to-r from-green-600 to-emerald-600 text-white rounded-lg hover:from-green-700 hover:to-emerald-700 transition-all duration-200 disabled:opacity-50 flex items-center space-x-2"
                  >
                    {isLoading ? (
                      <>
                ...
                <button
                  ...
                  className="px-6 py-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg hover:from-blue-700 hover:to-purple-700 transition-all duration-200 flex items-center space-x-2"
                >
                  <span></span>
          ...
          <div className="lg:col-span-3">
            ...
            {activeTab === 'activity' && (
              <div className="space-y-6">
                ...
                >
                  <ActivityTimeline activities={recentActivity} showPagination={true} />
                </ProfileCard>
              </div>
            )}
