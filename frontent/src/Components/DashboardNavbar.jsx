...
const DashboardNavbar = () => {
  ...
  const notifications = [
    { id: 1, title: 'New site added', message: 'Site Alpha-7 has been successfully added to monitoring', time: '2 min ago', type: 'success' },
    { id: 2, title: 'Device offline', message: 'Sensor Device #1205 lost connection', time: '15 min ago', type: 'warning' },
    { id: 3, title: 'Prediction alert', message: 'High risk detected at Site Beta-3', time: '1 hour ago', type: 'danger' },
    { id: 4, title: 'System update', message: 'AI model training completed successfully', time: '2 hours ago', type: 'info' },
  ];
            ...
            <div className="relative" ref={notificationRef}>
              ...
              >
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 17h5l-5.405-5.405A2.032 2.032 0 0115 9.594V7a6 6 0 00-12 0v2.594A2.032 2.032 0 012.595 11.405L7 17h8z" />
                </svg>
                {/* Notification Badge */}
                ...
                <div className="absolute right-0 mt-2 w-96 bg-white rounded-xl shadow-2xl border border-gray-200 py-2 transform opacity-100 scale-100 transition-all duration-200">
                  ...
                  <div className="max-h-96 overflow-y-auto">
                    {notifications.map((notification) => (
                      <div
                        key={notification.id}
                        className={`px-4 py-3 hover:bg-gray-50 cursor-pointer border-l-4 ${getNotificationColor(notification.type)} mx-2 my-1 rounded-r-lg`}
                      >
            ...
            <div className="relative" ref={profileRef}>
              ...
              >
                ...
                <div className="hidden sm:block text-left">
                  <p className="text-sm font-semibold text-gray-900">Rajveer</p>
                  <p className="text-xs text-gray-500">Mine Engineer</p>
                </div>
                {/* Dropdown Arrow */}
                ...
                <div className="absolute right-0 mt-2 w-64 bg-white rounded-xl shadow-2xl border border-gray-200 py-2 transform opacity-100 scale-100 transition-all duration-200">
                  ...
                  <div className="px-4 py-3 border-b border-gray-100">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <p className="font-semibold text-gray-900">Rajveer</p>
                        <p className="text-sm text-gray-500">Mine Engineer</p>
                        <p className="text-xs text-gray-400">RockfallPrediction@gmail.com</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="py-2">
                    ...
                    <button className="w-full px-4 py-2 text-left text-gray-700 hover:bg-blue-50 hover:text-blue-700 transition-colors flex items-center space-x-3">
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
