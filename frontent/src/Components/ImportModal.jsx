...
const ImportModal = ({ isOpen, onClose, device, importType }) => {
    ...
    switch (importType) {
      ...
      case 'LAS':
        return {
          ...
          accept: '.las,.laz',
          description: 'Upload LiDAR point cloud data files',
          icon: '🌐',
          maxSize: '100MB'
        };
      case 'Images':
        return {
          ...
          description: 'Upload aerial or survey images',
          icon: '📸',
          maxSize: '50MB'
        };
      default:
      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6">
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    Accepted formats: {typeInfo.accept} • Max size: {typeInfo.maxSize}
                  </p>
                </div>
                <input
                  type="file"
          ...
          <div className="mt-6 p-4 bg-gray-50 rounded-lg">
            <h4 className="font-semibold text-gray-800 mb-2">Import Guidelines:</h4>
